# Test Report - 2026-07-04 09:29:04

**eq_chatbot_core v1.17.2** | 7.72s | Python 3.13.12 | macOS-26.5.2-arm64-arm-64bit-Mach-O

> **Result: ALL PASSED - 1686 tests OK, 5 expected failures**
...
| **Provider: IONOS AI Model Hub** | - | 27 | 0 | 0 | 0 | 27 | 0.02s |
| **Provider: Melious.ai (sovereign EU)** | - | 28 | 0 | 0 | 0 | 28 | 0.02s |
| **Provider: Local (LM Studio / Ollama)** | - | 35 | 0 | 0 | 0 | 35 | 0.03s |
| **Security** | - | 423 | 0 | 0 | 5 | 428 | 0.05s |
| **RAG Pipeline** | - | 117 | 0 | 0 | 0 | 117 | 0.32s |
| **Services & Core** | - | 192 | 0 | 0 | 0 | 192 | 0.10s |
| **MCP Client** | - | 99 | 0 | 0 | 0 | 99 | 1.56s |
| **Other** | - | 463 | 0 | 0 | 0 | 463 | 2.96s |

## Detailed Results

### Unit Tests (1685 passed, 5 xfailed)

#### Provider: OpenAI (41 passed) - 0.03s
...
| `unit/test_openai.py::TestOpenAIChatCompletion::test_completion_with_max_tokens_legacy` | PASSED | 0.02s |
...
#### Provider: OpenRouter (40 passed) - 0.01s
...
#### Provider: IONOS AI Model Hub (27 passed) - 0.02s
...
#### Provider: Melious.ai (sovereign EU) (28 passed) - 0.02s
...
#### Services & Core (192 passed) - 0.10s
...
| `unit/test_factory.py::TestFactoryCloudProviders::test_get_ionos_provider` | PASSED | 0.03s |
| `unit/test_factory.py::TestFactoryCloudProviders::test_get_melious_provider` | PASSED | 0.03s |
...
| `unit/realtime/test_websocket_client.py::test_connect_with_backoff_all_failures_raises` | PASSED | 2.75s |
...
| `unit/test_langdock_export.py::TestHelpers::test_extract_agent_id_from_uuid` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestHelpers::test_extract_agent_id_from_ui_url` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestHelpers::test_extract_agent_id_from_url_with_query` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestHelpers::test_extract_agent_id_passthrough` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestHelpers::test_slugify` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestAgentMarkdown::test_markdown_contains_system_prompt` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestAgentMarkdown::test_markdown_frontmatter` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestAgentMarkdown::test_markdown_handles_missing_knowledge_folders` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestAgentMarkdown::test_markdown_handles_minimal_agent` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestDiscovery::test_parse_agents_csv` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestDiscovery::test_discover_agents_flow` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestDiscovery::test_discover_agents_without_download_url` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestExportManager::test_get_agent_unwraps_envelope` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestExportManager::test_get_agent_without_envelope` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestExportManager::test_get_agent_401_raises_auth_error` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestExportManager::test_export_report_rejects_unknown_report` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestExportManager::test_export_report_unwraps_data` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestExportManager::test_download_signed_csv_uses_bare_get` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestBackupAgents::test_backup_writes_md_and_json` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestBackupAgents::test_backup_json_only` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestBackupAgents::test_single_failure_does_not_abort` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestBackupAgents::test_backup_knowledge_metadata` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestBackupAgents::test_backup_knowledge_requires_manager` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestCLI::test_requires_something_to_do` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestCLI::test_agent_id_path` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestCLI::test_discovery_auth_failure_is_graceful` | PASSED | <0.01s |
| `unit/test_langdock_export.py::TestCLI::test_access_denied_prints_sharing_hint` | PASSED | <0.01s |
...
| `unit/test_security_hardening.py::TestPdfLimits::test_oversized_pdf_raises` | PASSED | 0.08s |
