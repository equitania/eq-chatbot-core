# Test Report - 2026-08-20 17:44:19

**eq_chatbot_core v3.1.1** | 149.90s | Python 3.13.12 | macOS-26.6.2-arm64-arm-64bit-Mach-O

> **Result: ALL PASSED - 45 tests OK, 21 skipped**

Command: `/Users/picard/gitbase/PyPi-Projects/eq_chatbot_core/.venv/lib/python3.13/site-packages/pytest/__main__.py tests/integration/ -q --no-header -p no:cacheprovider`
...
| Local (LM Studio / Ollama) | `glm-4.7-flash:latest` | $0 (local) | Registry primary | INFO — `list_models()` does not list `glm-4.7-flash:latest` (1 listed); chat call will validate |
...
|--------|------------|--------|--------|---------|---------|-------|----------|
| **Provider: OpenAI** | `gpt-4o-mini` | 17 | 0 | 0 | 0 | 17 | 12.93s |
| **Provider: OpenRouter** | `mistralai/mistral-nemo` | 5 | 0 | 0 | 0 | 5 | 2.87s |
| **Provider: Mammouth AI** | `gpt-5.4-nano` | 6 | 0 | 0 | 0 | 6 | 5.40s |
| **Provider: LiteLLM Gateway** | - | 0 | 0 | 5 | 0 | 5 | 1.51s |
| **Provider: IONOS AI Model Hub** | - | 0 | 0 | 4 | 0 | 4 | <0.01s |
| **Provider: Melious.ai (sovereign EU)** | `nemotron-3-nano-30b-a3b` | 4 | 0 | 0 | 0 | 4 | 2.27s |
| **Provider: Privatemode.ai (end-to-end encrypted)** | - | 0 | 0 | 5 | 0 | 5 | 1.24s |
| **Provider: Local (LM Studio / Ollama)** | `glm-4.7-flash:latest` | 11 | 0 | 0 | 0 | 11 | 117.02s |
| **MCP Client** | - | 1 | 0 | 5 | 0 | 6 | 0.02s |
| **Other** | - | 1 | 0 | 2 | 0 | 3 | 2.76s |

## Detailed Results

### Integration Tests (45 passed, 21 skipped)

#### Provider: OpenAI (17 passed) - 12.93s | Model: `gpt-4o-mini`

| Test | Status | Duration |
|------|--------|----------|
| `integration/test_openai_live.py::TestOpenAILive::test_simple_completion` | PASSED | 0.85s |
| `integration/test_openai_live.py::TestOpenAILive::test_list_models` | PASSED | 0.92s |
| `integration/test_openai_live.py::TestOpenAILive::test_streaming_completion` | PASSED | 0.70s |
| `integration/test_openai_live.py::TestOpenAILive::test_system_message` | PASSED | 1.13s |
| `integration/test_openai_live.py::TestOpenAILive::test_json_mode` | PASSED | 1.15s |
| `integration/test_openai_live.py::TestAnthropicLive::test_simple_completion` | PASSED | 0.86s |
| `integration/test_openai_live.py::TestAnthropicLive::test_list_models` | PASSED | 0.33s |
| `integration/test_openai_live.py::TestAnthropicLive::test_streaming_completion` | PASSED | 0.83s |
| `integration/test_openai_live.py::TestAnthropicLive::test_system_message` | PASSED | 0.89s |
| `integration/test_openai_live.py::TestLangDockLive::test_simple_completion` | PASSED | 0.82s |
| `integration/test_openai_live.py::TestLangDockLive::test_list_models` | PASSED | 0.19s |
| `integration/test_openai_live.py::TestLangDockLive::test_streaming_completion` | PASSED | 0.76s |
| `integration/test_openai_live.py::TestLangDockLive::test_system_message` | PASSED | 0.78s |
| `integration/test_openai_live.py::TestLangDockLive::test_eu_region` | PASSED | 0.74s |
| `integration/test_openai_live.py::TestLangDockAnthropicBackend::test_anthropic_completion` | PASSED | 1.01s |
| `integration/test_openai_live.py::TestLangDockAnthropicBackend::test_anthropic_list_models` | PASSED | 0.19s |
| `integration/test_openai_live.py::TestCostEffectivePatterns::test_minimal_token_usage` | PASSED | 0.77s |

#### Provider: OpenRouter (5 passed) - 2.87s | Model: `mistralai/mistral-nemo`

| Test | Status | Duration |
|------|--------|----------|
| `integration/test_openrouter_live.py::TestOpenRouterLive::test_simple_completion` | PASSED | 0.74s |
| `integration/test_openrouter_live.py::TestOpenRouterLive::test_list_models` | PASSED | 0.18s |
| `integration/test_openrouter_live.py::TestOpenRouterLive::test_streaming_completion` | PASSED | 0.80s |
| `integration/test_openrouter_live.py::TestOpenRouterLive::test_system_message` | PASSED | 0.71s |
| `integration/test_openrouter_live.py::TestOpenRouterLive::test_provider_prefix_routing` | PASSED | 0.45s |

#### Provider: Mammouth AI (6 passed) - 5.40s | Model: `gpt-5.4-nano`

| Test | Status | Duration |
|------|--------|----------|
| `integration/test_mammouth_live.py::TestMammouthLive::test_simple_completion` | PASSED | 2.02s |
| `integration/test_mammouth_live.py::TestMammouthLive::test_list_models` | PASSED | 0.19s |
| `integration/test_mammouth_live.py::TestMammouthLive::test_list_models_has_temperature_constraints` | PASSED | 0.17s |
| `integration/test_mammouth_live.py::TestMammouthLive::test_streaming_completion` | PASSED | 0.96s |
| `integration/test_mammouth_live.py::TestMammouthLive::test_system_message` | PASSED | 0.81s |
| `integration/test_mammouth_live.py::TestMammouthLive::test_context_manager` | PASSED | 1.24s |

#### Provider: LiteLLM Gateway (5 skipped) - 1.51s
...
#### Provider: Melious.ai (sovereign EU) (4 passed) - 2.27s | Model: `nemotron-3-nano-30b-a3b`

| Test | Status | Duration |
|------|--------|----------|
| `integration/test_melious_live.py::TestMeliousLive::test_simple_completion` | PASSED | 0.74s |
| `integration/test_melious_live.py::TestMeliousLive::test_streaming_completion` | PASSED | 0.94s |
| `integration/test_melious_live.py::TestMeliousLive::test_list_models` | PASSED | 0.14s |
| `integration/test_melious_live.py::TestMeliousLive::test_context_manager` | PASSED | 0.45s |

#### Provider: Privatemode.ai (end-to-end encrypted) (5 skipped) - 1.24s
...
#### Provider: Local (LM Studio / Ollama) (11 passed) - 117.02s | Model: `glm-4.7-flash:latest`
...
| `integration/test_local_live.py::TestLMStudioLive::test_simple_completion` | PASSED | 26.19s |
| `integration/test_local_live.py::TestLMStudioLive::test_system_message` | PASSED | 0.25s |
| `integration/test_local_live.py::TestLMStudioLive::test_streaming_completion` | PASSED | 5.50s |
| `integration/test_local_live.py::TestLMStudioLive::test_multiple_turns` | PASSED | 16.89s |
| `integration/test_local_live.py::TestLocalProviderGeneric::test_provider_properties` | PASSED | <0.01s |
| `integration/test_local_live.py::TestLocalProviderGeneric::test_chat_completion_returns_llm_response` | PASSED | 25.78s |
| `integration/test_local_live.py::TestLocalProviderGeneric::test_stream_completion_yields_chunks` | PASSED | 17.82s |
| `integration/test_local_live.py::TestLocalProviderGeneric::test_temperature_parameter` | PASSED | 24.56s |
...
#### Other (1 passed, 2 skipped) - 2.76s
...
| `integration/test_realtime_openai_live.py::test_openai_realtime_session_ready_and_pcm_chunk` | PASSED | 2.76s |  |
