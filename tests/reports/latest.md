# Test Report - 2026-02-24 15:50:45

**eq_chatbot_core v1.2.0** | 2.89s | Python 3.13.2 | macOS-26.3-arm64-arm-64bit-Mach-O
...
| **Provider: Azure AI** | `Phi-4` | 38 | 0 | 0 | 0 | 38 | 0.03s |
...
#### Provider: Azure AI (38 passed) - 0.03s | Model: `Phi-4`
...
| `unit/test_azure.py::TestAzureChatCompletion::test_completion_with_tools` | PASSED | 0.02s |
