# Test Report - 2026-08-23 20:11:01

**eq_chatbot_core v3.1.1** | 8.99s | Python 3.13.12 | macOS-26.6.2-arm64-arm-64bit-Mach-O

> **Result: ALL PASSED - 1858 tests OK, 5 expected failures**

Command: `/Users/picard/gitbase/PyPi-Projects/eq_chatbot_core/.venv/lib/python3.13/site-packages/pytest/__main__.py tests/unit/ -q --no-header -p no:cacheprovider`
...
| LangDock (Google backend) | — | LangDock gateway (see langdock.com pricing) | — | SKIPPED — provider not exercised this run |
...
| Melious.ai | — | not published by the API (sovereign EU gateway, 30B MoE / 3B active) | — | SKIPPED — provider not exercised this run |
...
| **Provider: Anthropic** | - | 51 | 0 | 0 | 0 | 51 | 0.13s |
| **Provider: LangDock** | - | 60 | 0 | 0 | 0 | 60 | 0.04s |
| **Provider: OpenRouter** | - | 38 | 0 | 0 | 0 | 38 | 0.01s |
| **Provider: Mammouth AI** | - | 41 | 0 | 0 | 0 | 41 | 0.01s |
...
| **RAG Pipeline** | - | 117 | 0 | 0 | 0 | 117 | 0.34s |
| **Services & Core** | - | 166 | 0 | 0 | 0 | 166 | 0.09s |
| **MCP Client** | - | 99 | 0 | 0 | 0 | 99 | 1.57s |
| **Other** | - | 667 | 0 | 0 | 0 | 667 | 3.77s |

## Detailed Results

### Unit Tests (1858 passed, 5 xfailed)
...
| `unit/test_openai.py::TestOpenAIChatCompletion::test_temperature_is_omitted_for_the_default_model` | PASSED | <0.01s |
...
#### Provider: Anthropic (51 passed) - 0.13s
...
| `unit/test_anthropic.py::TestAnthropicProviderInit::test_client_property_creates_client` | PASSED | 0.09s |
...
| `unit/test_anthropic.py::TestAnthropicChatCompletion::test_no_temperature_at_all_for_the_default_model` | PASSED | <0.01s |
...
#### Provider: LangDock (60 passed) - 0.04s
...
#### Provider: OpenRouter (38 passed) - 0.01s
...
#### Provider: Mammouth AI (41 passed) - 0.01s
...
| `unit/test_mammouth.py::TestMammouthTemperatureConstraints::test_gpt5_temperature_is_generation_specific` | PASSED | <0.01s |
...
#### Provider: Privatemode.ai (end-to-end encrypted) (29 passed) - 0.02s

| Test | Status | Duration |
|------|--------|----------|
| `unit/test_privatemode.py::TestPrivatemodeProviderInit::test_basic_init_defaults_to_local_proxy` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestPrivatemodeProviderInit::test_api_key_optional_uses_placeholder` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestPrivatemodeProviderInit::test_api_key_passed_through_when_given` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestPrivatemodeProviderInit::test_private_range_allowed` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestPrivatemodeProviderInit::test_ssrf_metadata_still_blocked` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestPrivatemodeProviderInit::test_non_http_scheme_blocked` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestPrivatemodeProviderInit::test_lazy_client` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestPrivatemodeProviderInit::test_client_created_with_default_base_url` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestPrivatemodeProviderProperties::test_provider_name` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestPrivatemodeProviderProperties::test_default_model_fallback` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestPrivatemodeProviderProperties::test_default_model_override` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestConfidentialityBoundary::test_loopback_needs_no_dns_lookup` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestConfidentialityBoundary::test_public_host_over_plain_http_is_refused` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestConfidentialityBoundary::test_public_host_over_plain_http_allowed_with_override` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestConfidentialityBoundary::test_https_is_allowed_without_lookup` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestConfidentialityBoundary::test_private_host_over_plain_http_is_allowed_and_noted` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestConfidentialityBoundary::test_mixed_resolution_with_any_public_address_is_refused` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestConfidentialityBoundary::test_unresolvable_host_warns_and_defers` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestExtraBodyRouting::test_cache_salt_is_routed_into_extra_body` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestExtraBodyRouting::test_chat_template_kwargs_is_routed_into_extra_body` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestExtraBodyRouting::test_explicit_extra_body_is_merged_not_replaced` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestExtraBodyRouting::test_no_extra_body_when_nothing_requested` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestPrivatemodeChatCompletion::test_basic_completion` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestPrivatemodeChatCompletion::test_default_model_is_used` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestPrivatemodeStreaming::test_stream_yields_content_and_final_usage` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestPrivatemodeListModels::test_list_models` | PASSED | <0.01s |
| `unit/test_privatemode.py::TestPrivatemodeErrorHandling::test_auth_error_mapped` | PASSED | <0.01s |
...
| `unit/test_local.py::TestLocalLLMProviderInit::test_custom_base_url` | PASSED | 0.02s |
...
| `unit/test_retriever.py::TestRetrieveSuccess::test_retrieve_returns_retrieval_results` | PASSED | 0.32s |
...
#### Services & Core (166 passed) - 0.09s
...
| `unit/test_factory.py::TestFactoryLocalProviders::test_local_alias_custom_base_url_override` | PASSED | 0.02s |
...
| `unit/test_temperature_constraints.py::TestGetTemperatureConstraints::test_case_insensitive_deepseek_v3_mixed_case_form` | PASSED | <0.01s |
...
| `unit/realtime/test_websocket_client.py::test_connect_with_backoff_all_failures_raises` | PASSED | 1.32s |
...
| `unit/test_anthropic_temperature_transport.py::TestApplyAnthropicTemperature::test_older_model_travels_in_extra_body` | PASSED | <0.01s |
| `unit/test_anthropic_temperature_transport.py::TestApplyAnthropicTemperature::test_reasoning_model_gets_no_temperature_at_all` | PASSED | <0.01s |
| `unit/test_anthropic_temperature_transport.py::TestApplyAnthropicTemperature::test_value_is_clamped_before_it_travels` | PASSED | <0.01s |
| `unit/test_anthropic_temperature_transport.py::TestApplyAnthropicTemperature::test_existing_extra_body_is_preserved` | PASSED | <0.01s |
| `unit/test_anthropic_temperature_transport.py::TestApplyAnthropicTemperature::test_returns_whether_it_applied_anything` | PASSED | <0.01s |
| `unit/test_capability_catalog.py::TestCapabilities::test_resolved_flags` | PASSED | <0.01s |
| `unit/test_capability_catalog.py::TestCapabilities::test_limits` | PASSED | <0.01s |
...
| `unit/test_cli_image.py::TestImageCommand::test_fit_option_resizes_image` | PASSED | 0.04s |
...
| `unit/test_document_extractor.py::TestRichFormats::test_html_extraction` | PASSED | 0.01s |
...
| `unit/test_gpt5_temperature.py::test_temperature_is_omitted_where_openai_refuses_it[gpt-5]` | PASSED | <0.01s |
| `unit/test_gpt5_temperature.py::test_temperature_is_omitted_where_openai_refuses_it[gpt-5-mini]` | PASSED | <0.01s |
| `unit/test_gpt5_temperature.py::test_temperature_is_omitted_where_openai_refuses_it[gpt-5-nano]` | PASSED | <0.01s |
| `unit/test_gpt5_temperature.py::test_temperature_is_omitted_where_openai_refuses_it[gpt-5-2025-08-07]` | PASSED | <0.01s |
| `unit/test_gpt5_temperature.py::test_temperature_is_omitted_where_openai_refuses_it[gpt-5.5]` | PASSED | <0.01s |
| `unit/test_gpt5_temperature.py::test_temperature_is_omitted_where_openai_refuses_it[gpt-5.6-luna]` | PASSED | <0.01s |
| `unit/test_gpt5_temperature.py::test_temperature_is_omitted_where_openai_refuses_it[gpt-5.6-sol]` | PASSED | <0.01s |
| `unit/test_gpt5_temperature.py::test_temperature_is_omitted_where_openai_refuses_it[gpt-5.6-terra]` | PASSED | <0.01s |
| `unit/test_gpt5_temperature.py::test_temperature_still_passes_where_it_is_accepted[gpt-5.1]` | PASSED | <0.01s |
| `unit/test_gpt5_temperature.py::test_temperature_still_passes_where_it_is_accepted[gpt-5.2]` | PASSED | <0.01s |
| `unit/test_gpt5_temperature.py::test_temperature_still_passes_where_it_is_accepted[gpt-5.4]` | PASSED | <0.01s |
| `unit/test_gpt5_temperature.py::test_temperature_still_passes_where_it_is_accepted[gpt-5.4-mini]` | PASSED | <0.01s |
| `unit/test_gpt5_temperature.py::test_temperature_still_passes_where_it_is_accepted[gpt-4.1]` | PASSED | <0.01s |
| `unit/test_gpt5_temperature.py::test_temperature_still_passes_where_it_is_accepted[gpt-4o]` | PASSED | <0.01s |
| `unit/test_gpt5_temperature.py::test_unknown_future_gpt5_generation_defaults_to_omitting` | PASSED | <0.01s |
| `unit/test_gpt5_temperature.py::test_provider_prefixed_ids_resolve_the_same_way` | PASSED | <0.01s |
| `unit/test_langdock_agent_errors.py::TestAgentErrorMessage::test_auto_model_points_at_the_agent_model_setting` | PASSED | <0.01s |
| `unit/test_langdock_agent_errors.py::TestAgentErrorMessage::test_auto_model_matching_is_case_insensitive` | PASSED | <0.01s |
| `unit/test_langdock_agent_errors.py::TestAgentErrorMessage::test_default_model_wording_alone_is_enough` | PASSED | <0.01s |
| `unit/test_langdock_agent_errors.py::TestAgentErrorMessage::test_other_400_points_at_agent_id_and_sharing` | PASSED | <0.01s |
| `unit/test_langdock_agent_errors.py::TestAgentErrorMessage::test_401_points_at_the_api_key` | PASSED | <0.01s |
| `unit/test_langdock_agent_errors.py::TestAgentErrorMessage::test_unmapped_status_keeps_the_upstream_body` | PASSED | <0.01s |
| `unit/test_langdock_agent_errors.py::TestAgentErrorMessage::test_empty_body_does_not_crash` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestSSEParsing::test_yields_one_object_per_event` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestSSEParsing::test_glued_events_are_both_recovered` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestSSEParsing::test_done_sentinel_is_not_emitted` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestSSEParsing::test_malformed_json_is_skipped_not_raised` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestAgentStreamCompletion::test_request_actually_asks_for_a_stream` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestAgentStreamCompletion::test_text_arrives_incrementally` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestAgentStreamCompletion::test_last_chunk_is_final` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestAgentStreamCompletion::test_reasoning_events_do_not_leak_into_content` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestAgentStreamCompletion::test_error_event_raises_with_its_text` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestAgentStreamCompletion::test_http_error_is_translated_not_swallowed` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestAgentStreamCompletion::test_error_body_is_read_before_access` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestAgentChatCompletionStreamsInternally::test_request_asks_for_a_stream` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestAgentChatCompletionStreamsInternally::test_deltas_are_assembled_into_one_answer` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestAgentChatCompletionStreamsInternally::test_model_name_comes_from_the_start_event` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestAgentChatCompletionStreamsInternally::test_model_falls_back_to_the_agent_id` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestAgentChatCompletionStreamsInternally::test_http_error_is_translated` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestAgentChatCompletionStreamsInternally::test_error_event_raises` | PASSED | <0.01s |
| `unit/test_langdock_agent_streaming.py::TestAgentChatCompletionStreamsInternally::test_empty_message_list_never_reaches_the_network` | PASSED | <0.01s |
...
| `unit/test_langdock_backends.py::TestAgentChatCompletion::test_assembles_the_streamed_deltas` | PASSED | <0.01s |
...
| `unit/test_langdock_backends.py::TestAgentChatCompletion::test_stream_without_text_yields_empty_content` | PASSED | <0.01s |
| `unit/test_langdock_backends.py::TestAgentStreamCompletion::test_deltas_arrive_as_separate_chunks` | PASSED | <0.01s |
| `unit/test_langdock_backends.py::TestAgentStreamCompletion::test_empty_stream_still_terminates` | PASSED | <0.01s |
...
| `unit/test_langdock_backends.py::TestListModels::test_google_listing_comes_from_the_live_endpoint` | PASSED | <0.01s |
...
| `unit/test_langdock_google_models.py::TestGoogleModelListing::test_models_come_from_the_live_endpoint` | PASSED | <0.01s |
| `unit/test_langdock_google_models.py::TestGoogleModelListing::test_models_prefix_is_stripped` | PASSED | <0.01s |
| `unit/test_langdock_google_models.py::TestGoogleModelListing::test_entries_keep_the_provider_metadata` | PASSED | <0.01s |
| `unit/test_langdock_google_models.py::TestGoogleModelListing::test_no_hardcoded_25_flash_anywhere` | PASSED | <0.01s |
| `unit/test_langdock_google_models.py::TestGoogleModelListing::test_default_model_is_one_langdock_actually_serves` | PASSED | <0.01s |
| `unit/test_langdock_google_models.py::TestCodestralDefaults::test_default_model_is_the_served_id` | PASSED | <0.01s |
| `unit/test_langdock_google_models.py::TestCodestralDefaults::test_chat_listing_stays_empty_on_purpose` | PASSED | <0.01s |
| `unit/test_langdock_google_models.py::TestGoogleStreaming::test_request_asks_for_sse` | PASSED | <0.01s |
| `unit/test_langdock_google_models.py::TestGoogleStreaming::test_text_arrives_in_chunks` | PASSED | <0.01s |
| `unit/test_langdock_google_models.py::TestGoogleStreaming::test_usage_lands_on_the_final_chunk` | PASSED | <0.01s |
| `unit/test_langdock_http_error_detail.py::TestGoogleErrorDetail::test_invalid_model_reason_reaches_the_caller` | PASSED | <0.01s |
| `unit/test_langdock_http_error_detail.py::TestGoogleErrorDetail::test_401_still_maps_to_authentication_error` | PASSED | <0.01s |
...
| `unit/test_openrouter_error_handling.py::test_streaming_error_body_is_read_not_crashed` | PASSED | <0.01s |
| `unit/test_openrouter_error_handling.py::test_streaming_error_without_json_body_still_returns_provider_error` | PASSED | <0.01s |
| `unit/test_openrouter_error_handling.py::test_non_streaming_error_unchanged` | PASSED | <0.01s |
| `unit/test_openrouter_error_handling.py::test_status_code_is_preserved` | PASSED | <0.01s |
...
| `unit/test_pdf.py::TestConversion::test_all_pages_converted` | PASSED | 0.06s |
...
| `unit/test_pdf.py::TestResourceClamping::test_page_count_clamped_to_hard_limit` | PASSED | 1.05s |
| `unit/test_pdf.py::TestResourceClamping::test_zero_max_pages_still_renders_one_page` | PASSED | 0.02s |
| `unit/test_pdf.py::TestResourceClamping::test_excessive_dpi_clamped` | PASSED | 0.67s |
...
| `unit/test_websocket_is_connected.py::test_no_socket_is_not_connected` | PASSED | <0.01s |
| `unit/test_websocket_is_connected.py::test_open_state_counts_as_connected` | PASSED | <0.01s |
| `unit/test_websocket_is_connected.py::test_non_open_state_is_not_connected` | PASSED | <0.01s |
| `unit/test_websocket_is_connected.py::test_modern_socket_without_state_attribute_is_not_connected` | PASSED | <0.01s |
| `unit/test_websocket_is_connected.py::test_legacy_closed_attribute_still_honoured` | PASSED | <0.01s |
