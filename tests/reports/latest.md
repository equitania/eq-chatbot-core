# Test Report - 2026-02-13 11:41:33

**eq_chatbot_core v1.1.0** | 2.70s | Python 3.13.2 | macOS-26.3-arm64-arm-64bit-Mach-O

> **Result: ALL PASSED - 1051 tests OK, 5 expected failures**

Command: `/Users/picard/gitbase/PyPi-Projects/eq_chatbot_core/.venv/bin/pytest tests/unit/ -v --tb=short`
...
| **Services & Core** | - | 166 | 0 | 0 | 0 | 166 | 0.01s |
| **MCP Client** | - | 80 | 0 | 0 | 0 | 80 | 1.53s |

## Detailed Results

### Unit Tests (1051 passed, 5 xfailed)
...
#### Provider: LangDock (56 passed) - 0.03s | Model: `gpt-5.2`
...
| `unit/test_langdock.py::TestLangDockErrorHandling::test_authentication_error` | PASSED | 0.02s |
...
#### Provider: Azure AI (38 passed) - <0.01s | Model: `Phi-4`
...
| `unit/test_azure.py::TestAzureTemperatureConstraints::test_gpt41_min_temperature_clamped` | PASSED | <0.01s |
...
| `unit/test_azure.py::TestAzureChatCompletion::test_completion_temperature_clamped_gpt41` | PASSED | <0.01s |
...
| `unit/test_azure.py::TestAzureStreamCompletion::test_streaming_temperature_clamped` | PASSED | <0.01s |
...
#### Services & Core (166 passed) - 0.01s
