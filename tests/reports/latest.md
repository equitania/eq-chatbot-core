# Test Report - 2026-08-19 09:29:34

**eq_chatbot_core v2.1.0** | 10.62s | Python 3.13.12 | macOS-26.6.2-arm64-arm-64bit-Mach-O

> **Result: ALL PASSED - 1964 tests OK, 5 expected failures**
...
|--------|------------|--------|--------|---------|---------|-------|----------|
| **Provider: OpenAI** | - | 46 | 0 | 0 | 0 | 46 | 0.10s |
| **Provider: Anthropic** | - | 50 | 0 | 0 | 0 | 50 | 0.18s |
| **Provider: LangDock** | - | 60 | 0 | 0 | 0 | 60 | 0.05s |
| **Provider: OpenRouter** | - | 41 | 0 | 0 | 0 | 41 | 0.07s |
| **Provider: Mammouth AI** | - | 42 | 0 | 0 | 0 | 42 | 0.01s |
| **Provider: Azure AI** | - | 50 | 0 | 0 | 0 | 50 | 0.03s |
| **Provider: Google Vertex AI** | - | 45 | 0 | 0 | 0 | 45 | 0.01s |
...
| **RAG Pipeline** | - | 117 | 0 | 0 | 0 | 117 | 0.27s |
| **Services & Core** | - | 203 | 0 | 0 | 0 | 203 | 0.09s |
| **MCP Client** | - | 99 | 0 | 0 | 0 | 99 | 1.54s |
| **Other** | - | 639 | 0 | 0 | 0 | 639 | 4.68s |

## Detailed Results

### Unit Tests (1963 passed, 5 xfailed)

#### Provider: OpenAI (46 passed) - 0.10s
...
#### Provider: Anthropic (50 passed) - 0.18s
...
#### Provider: OpenRouter (41 passed) - 0.07s
...
| `unit/test_openrouter.py::TestOpenRouterStreamCompletion::test_stream_skips_sse_comment_lines` | PASSED | 0.06s |
...
#### Provider: Azure AI (50 passed) - 0.03s
...
#### Provider: Google Vertex AI (45 passed) - 0.01s
...
| `unit/test_retriever.py::TestRetrieveSuccess::test_retrieve_returns_retrieval_results` | PASSED | 0.26s |
...
#### Services & Core (203 passed) - 0.09s
...
| `unit/realtime/test_pyproject.py::test_realtime_extra_declared` | PASSED | 0.05s |
...
| `unit/realtime/test_websocket_client.py::test_connect_with_backoff_all_failures_raises` | PASSED | 2.25s |
...
| `unit/test_pdf.py::TestConversion::test_single_page_returns_one_png` | PASSED | 0.02s |
...
| `unit/test_pdf.py::TestConversion::test_max_pages_truncates` | PASSED | 0.04s |
| `unit/test_pdf.py::TestConversion::test_higher_dpi_produces_larger_image` | PASSED | 0.09s |
...
| `unit/test_pdf.py::TestResourceClamping::test_page_count_clamped_to_hard_limit` | PASSED | 1.04s |
