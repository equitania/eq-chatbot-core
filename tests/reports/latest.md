# Test Report - 2026-05-07 17:29:07

**eq_chatbot_core v1.7.0** | 0.26s | Python 3.13.12 | macOS-26.4.1-arm64-arm-64bit-Mach-O

> **Result: ALL PASSED - 38 tests OK**

Command: `.venv/bin/pytest tests/unit/server/ --tb=short -q`
...
|--------|------------|--------|--------|---------|---------|-------|----------|
| **Other** | - | 38 | 0 | 0 | 0 | 38 | 0.04s |

## Detailed Results

### Unit Tests (38 passed)

#### Other (38 passed) - 0.04s
