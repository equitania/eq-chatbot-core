# Test Report - 2026-05-08 11:51:05

**eq_chatbot_core v1.7.0** | 56.43s | Python 3.13.12 | macOS-26.4.1-arm64-arm-64bit-Mach-O
...
|--------|------------|--------|--------|---------|---------|-------|----------|
| **Provider: OpenAI** | `gpt-4o-mini` | 17 | 0 | 0 | 0 | 17 | 16.87s |
| **Provider: OpenRouter** | `deepseek/deepseek-v4-flash` | 5 | 0 | 0 | 0 | 5 | 9.08s |
| **Provider: Mammouth AI** | `gpt-4.1-nano` | 6 | 0 | 0 | 0 | 6 | 3.72s |
| **Provider: Azure AI** | - | 0 | 0 | 5 | 0 | 5 | <0.01s |
| **Provider: Google Vertex AI** | - | 0 | 0 | 5 | 0 | 5 | <0.01s |
| **Provider: Local (LM Studio / Ollama)** | `google/gemma-4-e4b` | 11 | 0 | 0 | 0 | 11 | 24.03s |
...
#### Provider: OpenAI (17 passed) - 16.87s | Model: `gpt-4o-mini`

| Test | Status | Duration |
|------|--------|----------|
| `integration/test_openai_live.py::TestOpenAILive::test_simple_completion` | PASSED | 2.09s |
| `integration/test_openai_live.py::TestOpenAILive::test_list_models` | PASSED | 0.71s |
| `integration/test_openai_live.py::TestOpenAILive::test_streaming_completion` | PASSED | 3.03s |
| `integration/test_openai_live.py::TestOpenAILive::test_system_message` | PASSED | 1.13s |
| `integration/test_openai_live.py::TestOpenAILive::test_json_mode` | PASSED | 0.78s |
| `integration/test_openai_live.py::TestAnthropicLive::test_simple_completion` | PASSED | 1.10s |
| `integration/test_openai_live.py::TestAnthropicLive::test_list_models` | PASSED | 0.22s |
| `integration/test_openai_live.py::TestAnthropicLive::test_streaming_completion` | PASSED | 0.86s |
| `integration/test_openai_live.py::TestAnthropicLive::test_system_message` | PASSED | 1.04s |
| `integration/test_openai_live.py::TestLangDockLive::test_simple_completion` | PASSED | 0.60s |
| `integration/test_openai_live.py::TestLangDockLive::test_list_models` | PASSED | 0.15s |
| `integration/test_openai_live.py::TestLangDockLive::test_streaming_completion` | PASSED | 0.65s |
| `integration/test_openai_live.py::TestLangDockLive::test_system_message` | PASSED | 1.44s |
| `integration/test_openai_live.py::TestLangDockLive::test_eu_region` | PASSED | 0.82s |
| `integration/test_openai_live.py::TestLangDockAnthropicBackend::test_anthropic_completion` | PASSED | 0.76s |
| `integration/test_openai_live.py::TestLangDockAnthropicBackend::test_anthropic_list_models` | PASSED | 0.15s |
| `integration/test_openai_live.py::TestCostEffectivePatterns::test_minimal_token_usage` | PASSED | 1.34s |

#### Provider: OpenRouter (5 passed) - 9.08s | Model: `deepseek/deepseek-v4-flash`

| Test | Status | Duration |
|------|--------|----------|
| `integration/test_openrouter_live.py::TestOpenRouterLive::test_simple_completion` | PASSED | 1.08s |
| `integration/test_openrouter_live.py::TestOpenRouterLive::test_list_models` | PASSED | 0.15s |
| `integration/test_openrouter_live.py::TestOpenRouterLive::test_streaming_completion` | PASSED | 2.42s |
| `integration/test_openrouter_live.py::TestOpenRouterLive::test_system_message` | PASSED | 3.74s |
| `integration/test_openrouter_live.py::TestOpenRouterLive::test_provider_prefix_routing` | PASSED | 1.71s |

#### Provider: Mammouth AI (6 passed) - 3.72s | Model: `gpt-4.1-nano`

| Test | Status | Duration |
|------|--------|----------|
| `integration/test_mammouth_live.py::TestMammouthLive::test_simple_completion` | PASSED | 0.77s |
| `integration/test_mammouth_live.py::TestMammouthLive::test_list_models` | PASSED | 0.10s |
| `integration/test_mammouth_live.py::TestMammouthLive::test_list_models_has_temperature_constraints` | PASSED | 0.14s |
| `integration/test_mammouth_live.py::TestMammouthLive::test_streaming_completion` | PASSED | 0.84s |
| `integration/test_mammouth_live.py::TestMammouthLive::test_system_message` | PASSED | 0.69s |
| `integration/test_mammouth_live.py::TestMammouthLive::test_context_manager` | PASSED | 1.19s |
...
#### Provider: Local (LM Studio / Ollama) (11 passed) - 24.03s | Model: `google/gemma-4-e4b`
...
| `integration/test_local_live.py::TestLMStudioLive::test_simple_completion` | PASSED | 0.43s |
| `integration/test_local_live.py::TestLMStudioLive::test_system_message` | PASSED | 0.27s |
| `integration/test_local_live.py::TestLMStudioLive::test_streaming_completion` | PASSED | 0.55s |
| `integration/test_local_live.py::TestLMStudioLive::test_multiple_turns` | PASSED | 6.74s |
| `integration/test_local_live.py::TestLocalProviderGeneric::test_provider_properties` | PASSED | <0.01s |
| `integration/test_local_live.py::TestLocalProviderGeneric::test_chat_completion_returns_llm_response` | PASSED | 6.59s |
| `integration/test_local_live.py::TestLocalProviderGeneric::test_stream_completion_yields_chunks` | PASSED | 8.85s |
| `integration/test_local_live.py::TestLocalProviderGeneric::test_temperature_parameter` | PASSED | 0.57s |
